  ...
  return (
    <div style={{ padding: "36px 40px" }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 28, gap: 16, flexWrap: "wrap" }}>
        <div>
          <h1 style={{ fontSize: 26, fontWeight: 800, color: "var(--text-primary)", margin: "0 0 6px", letterSpacing: "-0.01em" }}>Allowed Signup Domains</h1>
          <p style={{ fontSize: 14, color: "var(--text-muted)", margin: 0 }}>{rows.length} domain{rows.length !== 1 ? "s" : ""}</p>
        </div>
      ...
      <div style={{ background: "var(--bg-card)", borderRadius: 14, overflow: "hidden" }}>
        {loading ? (
          ...
          <div style={{ padding: 48, textAlign: "center", color: "var(--text-muted)", fontSize: 14 }}>No domains found.</div>
        ) : (
